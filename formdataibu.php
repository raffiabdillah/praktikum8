...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (empty($_POST["nama_ibu"])) {
            $error_nama_ibu = "Nama tidakboleh kosong";
        } else {
        ...
        include 'koneksi.php';
    if (empty($_POST["nama_ibu"]) || empty($_POST["tanggal"]) || empty($_POST["pendidikan"]) ||empty($_POST["pekerjaan"])||
    empty($_POST["penghasilan_bulanan"]) || empty($_POST["disabilitas"])) {
          ...
          $sql = mysqli_query($koneksi, "INSERT INTO dataibu (nama_ibu, tanggal_lahir, pendidikan, pekerjaan, penghasilan_bulanan, 
          disabilitas) VALUES ('$nama_ibu', '$tanggal_lahir', '$pendidikan', 
          '$pekerjaan', '$penghasilan_bulanan', '$disabilitas')");
          if ($sql) {
              // pesan jika data berhasil tersimpan
              echo "<script>alert('Terimakasih Sudah Mendaftar'); window.location.href='signup.php'
              </script>"; 
            } else {
                    ...
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <?php echo ($error_nama_ibu != "" ? "is-invalid" : ""); ?>" id="nama" placeholder="" value="<?php echo $nama_ibu; ?>">
